...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public ReviewEntity createReview(ReviewCreateVO vo) throws UserNotFoundException, UnableToCreateReviewException, ProjectNotFoundException {        //check if project exists
